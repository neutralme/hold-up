...
value != undefined || value != null ? decryptUrl() : location.href = 'https://lockmylink.netlify.app' + '/html/generate.html';
...
const submitData = () => {
  if (password.value.length >= 6) {
    if (MD5(btoa(password.value)) === value["p"]) {
      submit.classList.add("success");
      submit.innerText = "Success!"
      location.href = decrypt(value["u"], password.value)
    }
  } else {
